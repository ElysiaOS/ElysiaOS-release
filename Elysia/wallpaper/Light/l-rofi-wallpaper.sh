...
icon_dir="${HOME}/Elysia/wallpaper/Light/icon/"  # Directory containing matching icons
cacheDir="${HOME}/Elysia/wallpaper/Light/1366x768/${theme}"
cacheDir2="${HOME}/Elysia/wallpaper/Light/icon/${theme}"
